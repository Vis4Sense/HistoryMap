// copy from old-historymap/src/contentScript/highlight.js

highlight = function () {
	//Creating css link for fontello and inserting into header of webpage
	var cssLink = getCssHeaderLink("fontello");
	document.getElementsByTagName("head")[0].appendChild(cssLink); // Yuhan: this line would cause error in the console, have not figured out why
