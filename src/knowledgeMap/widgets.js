 ...
 */
knowledgeMap.zoom = function(container) {
 ...
 */
knowledgeMap.wheelPan = function(container) {
    // Add invisible rectangle covering the entire space to listen to mouse event.
    // Otherwise, only zoom when mouse-overing visible items.
    var parent = d3.select(container.node().parentNode);
    parent.insert("rect", ":first-child")
 ...
 */
knowledgeMap.addHorizontalPan = function(container, extent) {
 ...
 */
knowledgeMap.addPan = function(containers, parent, extent) {
 ...
 */
knowledgeMap.createArrowHeadMarker = function(parent, id, fillColor) {
 ...
 */
knowledgeMap.modal = function(head, body, draggable, x, y) {
 ...
 */
knowledgeMap.quickView = function(url) {
    var dialog = d3.select("body").append("div").attr("class", "modal fade").attr("tabindex", -1);
    var content = dialog.append("div").attr("class", "modal-dialog modal-lg")
        .append("div").attr("class", "modal-content");
 ...
 */
knowledgeMap.showCaptureDialog = function(info, callback) {
    var dialog = d3.select("body").append("div").attr("class", "modal fade").attr("tabindex", -1);
    var content = dialog.append("div").attr("class", "modal-dialog modal-lg")
        .append("div").attr("class", "modal-content");
 ...
 */
knowledgeMap.showTextDialog = function(info, isInput, callback) {
    var dialog = d3.select("body").append("div").attr("class", "modal fade").attr("tabindex", -1);
 ...
 */
knowledgeMap.showSimpleDialog = function(container, title, content, x, y, w, h) {
 ...
 */
knowledgeMap.addBootstrapTooltip = function(selection) {
